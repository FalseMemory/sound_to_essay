...
# 4. Add chapters section before version history
old_vh = '''    <section className="rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)] p-5">
      <h3 className="mb-4 text-xs font-semibold uppercase tracking-wider text-[var(--text-secondary)]">版本历史</h3>'''

new_vh = """    <section className="rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)] p-5">
...
content = content.replace(old_vh, new_vh)
